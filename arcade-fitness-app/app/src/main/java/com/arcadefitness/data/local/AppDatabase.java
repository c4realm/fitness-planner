...
public abstract class AppDatabase extends RoomDatabase {
    ...
    // ── MIGRATIONS ─────────────────────────────────────────────────────
    // Future schema changes: add a new Migration(N, N+1) here instead of
    // using destructive migration, which would silently wipe all user data.
    ...
    private static void populateDefaultExercisesIfEmpty(AppDatabase database) {
    ...
    private static ExerciseEntity createDefaultExercise(String name, String muscleGroup,
            ...
            new RoomDatabase.Callback() {
                ...
                public void onCreate(@NonNull SupportSQLiteDatabase db) {
                    ...
                    DATABASE_WRITE_EXECUTOR.execute(() -> {
                        ...
                        if (database != null) {
                            populateDefaultExercisesIfEmpty(database);
                        }
                    });
                }
